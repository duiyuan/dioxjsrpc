...
exports.pk2Address = pk2Address;
exports.seed2PairOfKey = seed2PairOfKey;
exports.encodeAddressBuffer = encodeAddressBuffer;
...
const getAddressShardIndex_1 = require("./getAddressShardIndex");
...
class Address {
    ...
    generateAddress() {
        return __awaiter(this, void 0, void 0, function* () {
            const keyPair = yield seed2PairOfKey(this.seed, this.salt);
            if (!keyPair)
            ...
            // console.log(address)
            return {
                address: (0, base32_encode_1.default)(address.address, 'Crockford').toLocaleLowerCase() + ':' + address.encryptMethod,
                words: this.words,
                seed: this.seed,
            };
        });
    ...
    generateSeed(seed) {
        try {
            ...
            if (!seed) {
                ...
                const randomData = crypto_1.default.getRandomValues(tableContainer);
...
function generateAddress(shardIndex) {
    return __awaiter(this, void 0, void 0, function* () {
        const addressInstance = new Address();
        const { address, seed } = yield addressInstance.generateAddress();
        if (shardIndex !== undefined) {
            const targetShardIndex = (0, getAddressShardIndex_1.addressToShard)(address);
...
function pk2Address(publicKey, rollingCRC = 3, encryptMethod = 0x3, salt = 1, alias) {
...
function seed2PairOfKey(seed_1) {
    return __awaiter(this, arguments, void 0, function* (seed, salt = new Uint8Array()) {
        ...
        const formatedSeed = (0, buffer_1.concat)(seed, salt);
        const privateKeyStr = (0, sha256_1.default)(formatedSeed, { asBytes: true });
...
function encodeAddressBuffer(address) {
    return (0, base32_encode_1.default)(address, 'Crockford').toLocaleLowerCase();
}
//# sourceMappingURL=generaterAddress.js.map