...
import { shakeKeyValue } from '../utils.js';
...
class DxService extends Request {
    ...
    shardInfo(shard_index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ shard_index }) });
            return this.handleResponse(resp);
        });
    }
    /**
    ...
    shardIndex(scope, scope_key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ scope, scope_key }) });
            return this.handleResponse(resp);
        });
    }
    mempool(shard_index, archived) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ shard_index, archived }) });
            return this.handleResponse(resp);
        });
    }
    /**
    ...
    contractState(contract_with_scope, scope_key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ contract_with_scope, scope_key }) });
            return this.handleResponse(resp);
        });
    }
    consensusHeader(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify(params) });
            return this.handleResponse(resp);
        });
    }
    ...
    transactionByHash(hash, shard_index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ hash, shard_index }) });
            return this.handleResponse(resp);
        });
    }
    dappInfo(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ name }) });
            return this.handleResponse(resp);
        });
    }
    generateKey(shard_index, algo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = shakeKeyValue({ shard_index, algo });
    ...
    isn(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ address }) });
            return this.handleResponse(resp);
        });
    }
    contractInfo(contract) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ contract }) });
            return this.handleResponse(resp);
        });
    }
    tokenInfo(symbol) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ symbol }) });
            return this.handleResponse(resp);
        });
    }
    blockTime(height) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield this.post(rpcUrl, { body: json.stringify({ height }) });
            return this.handleResponse(resp);
        });
    }
}
