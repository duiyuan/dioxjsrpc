...
import { addressToShard } from './getAddressShardIndex.js';
...
export function generateAddress(shardIndex) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function pk2Address(publicKey, rollingCRC = 3, encryptMethod = 0x3, salt = 1, alias) {
...
export function seed2PairOfKey(seed_1) {
...
export function encodeAddressBuffer(address) {
