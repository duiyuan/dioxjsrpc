...
describe("web3 unit test", () => {
  ...
  it('should get 10 dio', async () => {
    const balance = await web3.getBalance('eqfkk71rg18mcjcp63tkcz4xpcxd91wtd5atpwk82j2jmcdeb50j6es2xm:ed25519')
    const dioBalance = utils.toTokenAmount(balance, 8)
    expect(dioBalance).toEqual('10')
  })

  it('should get raw data', async () => {
